...
export function ConversationsBrowser({
  ...
  const filteredConversations = useMemo(() => {
    ...
    return sortedConversations.filter((conversation) => {
      const supplier = supplierName(suppliers, conversation.supplierId)
      const productNames = conversation.linkedSkus
      ...
      const haystack = [
        ...
        displayConversationSource(conversation.source),
        supplier,
        productNames,
  ...
  return (
    <>
      ...
      <section className="space-y-4">
        ...
        <FilterToolbar
          searchPlaceholder="Search conversations, suppliers, SKU, source, or state..."
          searchValue={query}
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-[#243047] hover:bg-transparent">
                  <TableHead className="px-4 text-[13px] text-[#9CA3AF]">Conversation ID</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Supplier</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Linked SKU(s)</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Product</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Source</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Latest Message</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Status</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Last Updated</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Priority</TableHead>
                  <TableHead className="text-[13px] text-[#9CA3AF]">Action</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
